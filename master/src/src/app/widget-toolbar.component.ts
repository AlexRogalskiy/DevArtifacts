...
@Component({
	...
	`
		<md-toolbar color="primary">
			...
			<button md-button (click)="openShoppingCart()"><md-icon svgIcon="shopping-cart" aria-hidden="true"></md-icon>&nbsp;&nbsp;{{ shoppingCartLabel }} [{{ this.totalAmount }}] ({{ totalPrice | currency:'RUB':true:'1.2-2' }})</button>
		</md-toolbar>
