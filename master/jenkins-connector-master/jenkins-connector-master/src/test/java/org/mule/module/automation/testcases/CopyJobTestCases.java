...
public class CopyJobTestCases extends JenkinsTestParent {
	
    @Before
	public void setUp() {
    	
		testObjects = (HashMap<String,Object>) context.getBean("copyJobTestData");
	...
	public void tearDown() {
		...
		testObjects.put("jobName", testObjects.get("newJobName").toString());
		flow.process(getTestEvent(testObjects));
	...
	@Test
	public void testCopyDeleteJob() {
		
		try {
			
	    flow = lookupFlowConstruct("copy-job");
		flow.process(getTestEvent(testObjects));
