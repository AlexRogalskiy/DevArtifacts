...
import com.ubs.network.api.rest.core.controller.interfaces.ITaskUnitController;
...
public class TaskUnitController<E extends TaskUnitEntity, D extends TaskUnitDTO> extends CoreBaseController<E, D> implements ITaskUnitController<E, D> {
    @Inject
