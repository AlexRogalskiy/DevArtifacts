...
var Docs = {
	...
	shebang: function() {
		...
		// If shebang has an operation nickname in integration..
		...
		switch (fragments.length) {
			case 1:
				// Expand all operations for the resource and scroll to integration
...
function program20(depth0,data) {
  ...
  return "\n          <div class='sandbox_header'>\n            <input class='submit' name='commit' type='button' value='Try integration out!' />\n            <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n            <span class='response_throbber' style='display:none'></span>\n          </div>\n          ";
  }
