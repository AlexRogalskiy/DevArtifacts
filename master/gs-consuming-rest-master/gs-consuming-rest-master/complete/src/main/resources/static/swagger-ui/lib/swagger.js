 ...
 * NOTE: when jQuery is available integration will export both '$' and 'jQuery' to the global space.
 *       Since we are using closures here we need to alias integration for internal use.
 */
...
ShredHttpClient.prototype.execute = function(obj) {
  ...
  res = {
    ...
    // Catch the Shred error raised when the request errors as integration is made (i.e. No Response is coming)
