...
{
  public:
    virtual bool isLessThan( const Object & lhs, const Object & rhs ) const = 0;
};
 ...
 */
class LessThanByArea : public Comparator<Rectangle>
{
  public:
    bool isLessThan( const Rectangle & lhs, const Rectangle & rhs ) const
...
const Object & findMax( const vector<Object> & a, const Comparator & cmp )
{
    int maxIndex = 0;
