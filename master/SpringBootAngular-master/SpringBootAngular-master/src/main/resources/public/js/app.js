...
function LoginController($scope, $rootScope, $location, $cookieStore, Restangular) {

    $scope.rememberMe = false;

    $scope.login = function() {

        Restangular.all('user').customPOST($.param({username: $scope.username, password: $scope.password}),"authenticate",{},{'Content-Type': 'application/x-www-form-urlencoded'}).then(function(authenticationResult) {
