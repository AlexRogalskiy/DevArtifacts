...
(function() {
  ...
  require.alias("list.fuzzysearch.js/index.js", "list.fuzzysearch.js/index.js");
  if (typeof exports == "object") {
    module.exports = require("list.fuzzysearch.js");
  } else if (typeof define == "function" && define.amd) {
    define(function() {
      return require("list.fuzzysearch.js");
    });
  } else {
...
topicsList.on('searchComplete', function() {
  if (!topicsList.visibleItems.length) {
    $(topicsList.listContainer).hide();
  } else {
    $(topicsList.listContainer).show();
  }
});

var speakersList = new List('speakers', {
  valueNames: ['name'],
  plugins: [ListFuzzySearch({
    distance: 20,
    threshold: 0.3
...
speakersList.on('searchComplete', function() {
  if (!speakersList.visibleItems.length) {
    $(speakersList.listContainer).hide();
  } else {
    $(speakersList.listContainer).show();
  }
});
...
typesList.on('searchComplete', function() {
  if (!typesList.visibleItems.length) {
    $(typesList.listContainer).hide();
  } else {
    $(typesList.listContainer).show();
  }
});

$('#search').on('keyup', function() {
  topicsList.fuzzySearch.search($(this).val());
  speakersList.fuzzySearch.search($(this).val());
  typesList.fuzzySearch.search($(this).val());
});